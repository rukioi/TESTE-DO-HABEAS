...
const dealSchema = z.object({
  ...
  contactName: z.string({ required_error: 'Nome do contato é obrigatório' }).min(1, 'Nome do contato é obrigatório'),
  ...
  stage: z.enum([ 'contacted', 'proposal', 'won', 'lost' ], { required_error: 'Etapa é obrigatória' }),
