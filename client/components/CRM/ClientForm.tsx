...
const clientSchema = z.object({
  ...
  country: z.string({ required_error: 'País é obrigatório' }).min(1, 'País é obrigatório'),
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit, handleInvalid)} className="space-y-6">
            ...
            <div className="flex justify-end">
              ...
              >
                {showAdvanced ? 'Ocultar cadastro completo' : 'Cadastro completo'}
              </Button>
            </div>
            {/* Informações Básicas */}
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button type="submit" disabled={saving}>
                ...
                {saving ? (isEditing ? 'Salvando...' : 'Adicionando...') : (isEditing ? 'Atualizar Cliente' : 'Adicionar Cliente')}
              </Button>
            </div>
          </form>
        </Form>
